...
public class AdjustedSavingsEnergyDepletion extends Stat{
	public AdjustedSavingsEnergyDepletion(String countryName) {
		try {
			Gson gson = new Gson();
			Reader reader = Files.newBufferedReader(Paths.get("\\Workspace\\3311Assignment\\src\\main\\resources\\adjusted_savings_energy_depletion.json"));
