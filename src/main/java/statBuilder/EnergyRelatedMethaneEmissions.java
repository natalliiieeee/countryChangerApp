...
public class EnergyRelatedMethaneEmissions extends Stat{
	public EnergyRelatedMethaneEmissions(String countryName) {
		try {
			Gson gson = new Gson();
			Reader reader = Files.newBufferedReader(Paths.get("\\Workspace\\3311Assignment\\src\\main\\resources\\energy_related_methane_emissions.json"));
