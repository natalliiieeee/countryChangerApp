...
public class ScatterChartTest {
	...
	public void test1() {
		...
		ScatterChart chart = new ScatterChart(new JPanel(), "Energy Use", "1998", "2008", cs);
	...
	public void test2() {
		...
		ScatterChart chart = new ScatterChart(new JPanel(), "Energy use vs. CO2 intensity", "1998", "2008", cs);
	...
	public void test4() {
		...
		ScatterChart chart = new ScatterChart(new JPanel(), "Energy Depletion/Population", "1998", "2008", cs);
		TimeSeriesCollection dataset = new TimeSeriesCollection();
